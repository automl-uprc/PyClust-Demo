...
from pyclust_eval.core._adg_operations import get_subgraph, visualize_subgraph, visualize_subgraph_as_tree
...
visualize_subgraph(processes, 'max_intra_cluster_distances')

visualize_subgraph_as_tree(processes, 'max_intra_cluster_distances')
